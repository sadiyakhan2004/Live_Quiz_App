...
const QuizComponent: React.FC<QuizPageProps> = ({ type, isQuiz, questions, review_Mode, quizName,setReview_Mode }) => {
  ...
  return (
    <div className="bg-gray-200 w-full flex flex-col justify-center min-h-screen items-center py-2 m-0 ">
      {isQuiz && questions && totalQuestions > 0 && (
        <div className="w-full max-w-3xl px-4 sm:px-8 border-2 bg-gray-100 h-[95vh]">
          {/* Top Section: Left buttons (Questions & Save) */}
          <div className="flex space-x-4 mb-2 mt-2">
            <button
              className="flex items-center p-2 bg-gray-200 rounded-md text-gray-600 hover:bg-gray-300"
          ...
          <div className="bg-white p-6 py-8 rounded-xl shadow-lg border-2 border-blue-800 h-[550px] overflow-y-auto w-full  ">
            <QuestionLayout
                    ...
                    {questions.map((question, index) => {
                      ...
                      return (
                        <tr key={index} className="border-b">
                          ...
                          <td className="py-2 px-4">Question {index + 1}</td>
          ...
          <div className="flex justify-between items-center mt-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="p-2 bg-gray-200 rounded-md text-gray-600 hover:bg-gray-300 disabled:opacity-50"
              >
                <FaChevronLeft />
              </button>
              <button
